(function() {
  ...
  angular
    .module('user')
    .component('userInvestorsNew', {
      controller: 'UserInvestorsNewController',
      templateUrl: 'app/modules/user/investors/investors.new.html'
    })
    .controller('UserInvestorsNewController', function(userCreateInvestorService, $confirm, Notification, listTagsService, listCompaniesService) {
      this.userCreateInvestorService = userCreateInvestorService;
      var controller = this;
      this.fundingTypes = [];
